	  ...
	  <table  border="0" cellpadding="1" cellspacing="5">
        ...
        <tr>
          ...
          <td align="center" valign="top">
		    <p>&nbsp;</p>
			<form name="createAccountForm" action="createAccount_exec.php" method="post">
			  <table width="50%" border="1" cellpadding="10" cellspacing="0" bordercolor="#CCCCCC" >
              <tr>
                <td align="left" class="bold"> Creare cont nou </td>
              </tr>
              <tr>
                <td align="left" valign="top" ><table width="100%" border="0" cellpadding="2">
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Nume utilizator </td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="create_username" type="text" class="box_200" id="create_username" maxlength="12" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Parola</td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="password1" type="password" class="box_200" id="password1" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Parola din nou </td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="password2" type="password" class="box_200" id="password2" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Nume si prenume </td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="fullname" type="text" class="box_200" id="fullname" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Adresa</td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="address" type="text" class="box_200" id="address" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Numar de telefon </td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="phone" type="text" class="box_200" id="phone" /></td>
                    </tr>
                    <tr>
                      <td align="left" nowrap="nowrap" class="arial">Adresa e-mail </td>
                      <td align="left" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input name="email" type="text" class="box_200" id="email" /></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" nowrap="nowrap" class="arial">&nbsp;</td>
                      <td align="left" nowrap="nowrap" class="arial">&nbsp;</td>
                      <td align="center" nowrap="nowrap" class="arial">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" nowrap="nowrap" class="arial">Conditii de utilizare</td>
                      <td align="left" nowrap="nowrap" class="arial">&nbsp;</td>
                      <td align="center" nowrap="nowrap" class="arial"><input name="accept_politica" type="checkbox" id="accept_politica" value="accept_politica" />
                        Accept regulile acestui site </td>
                    </tr>
                    <tr>
                      <td align="left" valign="top" nowrap="nowrap" class="arial">&nbsp;</td>
                      <td align="left" nowrap="nowrap" class="arial">&nbsp;</td>
                      <td align="center" nowrap="nowrap" class="arial"><input name="newsletter" type="checkbox" id="newsletter" value="newsletter" />
                        Doresc noutati prin e-mail </td>
                    </tr>
                    <tr>
                      <td nowrap="nowrap">&nbsp;</td>
                    ...
                    <tr>
                      <td nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap">&nbsp;</td>
                      <td align="center" nowrap="nowrap"><input type="button" class="box_120" value="Creeaza cont" onclick="createAccount()"/></td>
                    </tr>
                    <tr>
                      <td colspan="3" nowrap="nowrap"><div id="create_account_php_output" class="arial">&nbsp;</div></td>
                    </tr>
                </table>
