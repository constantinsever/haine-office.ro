    ...
    <tr>
	  ...
	  <table  border="0" cellpadding="1" cellspacing="5">
        ...
        <tr>
          ...
          <table width="90%" border="1" cellpadding="10" cellspacing="0" bordercolor="#CCCCCC" >
            <tr>
              <td align="left" class="bold" >Cosul de cumparaturi </td>
            </tr>
            <tr>
              <td align="left" class="arial" ><div id="delete_refresh_cart_php_output">
              <?php
	  ...
	  if (  !(isset($_SESSION['logged'])) ||  !(isset($_SESSION['fullname'])) || !((time() - $_SESSION['registered']) < 300 ))
	   ...
	   else 
	    {
			...
			$query = "select shopping_cart.product_id, shopping_cart.quantity, shopping_cart.product_id_cart, produse.titlu, produse.imagelist, produse.size_list, produse.color_list, produse.pret, produse.promotie, produse.pret_promotie, produse.stoc from shopping_cart, produse where shopping_cart.user_id='".$_SESSION['username']."' AND shopping_cart.product_id = produse.product_id;";
		  ...
		  echo " </form>";
			...
			echo "Nu aveti produse in cosul de cumparaturi.";
