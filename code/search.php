	  ...
	  <table  border="0" cellpadding="1" cellspacing="5">
        ...
        <tr>
		  ...
		  <?php 
				...
				$query = "select * from produse where ((titlu like '%".$criteria."%') or (descriere like '%".$criteria."%'))  order by pret ASC;";
				...
				if ($num_records == 0)
                 ...
                 else				
				 {
				  ...
				  $end = $start + 7;
				   ...
				   {
					 if (($num_records % 8) == 0)
					  $num_pages = floor($num_records/8) ;
					  else
					  $num_pages = floor($num_records/8) + 1;
					};
				    ...
				    if ($num_pages > 1) 
					 {
					  echo "<td colspan=\"4\" class=\"bold\" align=\"right\">Au fost gasite ".$num_records." produse. Salt rapid la pagina : ";
				      for ($i = 1; $i <= $num_pages; $i++)
          	          echo "<a  href=\"javascript: void(0)\" onclick=\"searchProducts('".$criteria."','".$i."')\">&nbsp;".$i."&nbsp;</a>";
 				      }; 
				   echo  "</td></tr>";
						...
						<td>
						 <div onClick=\"document.getElementById('product_id').value='".$row['product_id']."'; document.show_details.submit()\" style=\"cursor:pointer\" >
					      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
						   <tr><td  align=\"center\"><img src=\"../image_uploads/".$imageArray[0]."\" width=\"170\" height=\"210\" ></td>
